...
module I18n::Tasks::Translators
  class DeeplTranslator < BaseTranslator
    ...
    def options_for_translate_values(**options)
      ...
      extra_options.merge({ tag_handling: 'xml', ignore_tags: %w[i18n] }).merge(options)
    end
    ...
    def to_deepl_target_locale(locale)
      ...
      if SPECIFIC_TARGETS.include?(loc)
        ...
        I18n::Tasks::Logging.warn_deprecated I18n.t('i18n_tasks.deepl_translate.errors.specific_target_missing') unless sub
        locale.to_s.upcase
      else
        loc.upcase
      end
